<template>
    <svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="29" y="34" width="17" height="4"/>
        <rect x="29" y="46" width="17" height="4"/>
        <rect x="29" y="58" width="17" height="4"/>
        <rect x="29" y="70" width="17" height="4"/>
        <rect x="57.5" y="56.5" width="7" height="7"/>
        <rect x="57.5" y="68.5" width="7" height="7"/>
        <path d="M52.9 35.8 55 33.7 57.6 36.3 64.2 29.7 66.3 31.8 57.6 40.5Z"/>
        <path d="M52.9 47.8 55 45.7 57.6 48.3 64.2 41.7 66.3 43.8 57.6 52.5Z"/>
    </svg>
</template>
